...
const VERDICTS = [
  "El sujeto firmará cuanto se le presente y, a su vez, será firmado por otros.",
  ...
  "El archivo confirma lo que el sujeto ya temía: alguien firmó por él hace tiempo.",
  "La sangre no se elige; los pactos heredados, tampoco.",
  "El sujeto repetirá tres veces aquello de lo que cree haber escapado una.",
  "La política española no se entiende sin el rumor que la sostiene en pie.",
  "Quien se reconoce en estos espejos no sale ya por la misma puerta.",
  "La Logia toma nota y archiva sin sentencia: la sentencia se dicta sola.",
  "El sujeto se quedará a las puertas de la Moncloa por motivos que no son los suyos.",
  "Lo que el archivo declara, el tiempo lo subraya con tinta más oscura.",
  "Conviene al sujeto mudar de barbero y de confesor antes de que acabe el otoño.",
  "No hay biografía limpia: solo expedientes mejor encuadernados.",
  "Tres nombres laten en el sello; ninguno de ellos es del todo el suyo.",
];
