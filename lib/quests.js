...
export const QUESTS = {
  ...
  mocion_censura: {
    id: "mocion_censura",
    title: "La Moción de Censura",
    premise: "Hay escaños que comprar, alianzas que tejer y un gobierno que no sabe que caerá en tres semanas.",
    via: "poder",
    acts: [
      { id: "acto_contactos", goal: "Reunir apoyos: conseguir 2 claves de votación en el Congreso.", requires: { cluesMin: 2 }, reward: [{ type: E.INFLUENCE, value: 2 }, { type: E.REPUTATION_FACTION, faction: "aparato", value: 1 }] },
      { id: "acto_negociacion", goal: "Negociar el apoyo de un grupo minoritario en la sede del partido.", requires: { cluesMin: 4 }, reward: [{ type: E.INFLUENCE, value: 2 }, { type: E.REPUTATION_FACTION, faction: "calle", value: 1 }] },
      { id: "acto_votacion", goal: "Presentar la moción en el hemiciclo y ganar la votación.", requires: { flag: "mocion_presentada" }, reward: [{ type: E.INFLUENCE, value: 4 }, { type: E.REPUTATION_FACTION, faction: "aparato", value: 2 }, { type: E.THREAT, value: -1 }] },
    ],
    failConditions: { doomMin: 12 },
  },
};
