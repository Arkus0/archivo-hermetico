    ...
    nodes: {
      open: {
        ...
        options: [
          ...
          { label: "Proponer pacto de gobernabilidad", next: "negociacion" },
      ...
      negociacion: {
        text: "Sánchez para. «¿Cuántos escaños traes?». Es la primera pregunta real. Los amanuenses pueden esperar.",
        options: [
          { label: "Presentar los números del acuerdo", check: { stat: "recursos", difficulty: 10 },
            outcomes: {
              critical: { text: "Acepta los términos. Firma en la agenda sin secretario.", effects: [{ type: E.INFLUENCE, value: 4 }, { type: E.CLUE, questId: "mocion_censura", clue: "acuerdo_gobierno" }, { type: E.REPUTATION_FACTION, faction: "aparato", value: 1 }] },
              success:  { text: "Pide veinticuatro horas. Es casi un sí.", effects: [{ type: E.INFLUENCE, value: 2 }, { type: E.REPUTATION_POL, id: "sanchez", value: 1 }] },
              fail:     { text: "No son suficientes. Los amanuenses vuelven.", effects: [] },
              fumble:   { text: "Convoca portavoces sin avisarte. Sales por la puerta de servicio.", effects: [{ type: E.THREAT, value: 1 }, { type: E.REPUTATION_FACTION, faction: "aparato", value: -1 }] },
            },
          },
          { label: "Salir sin compromiso", isExit: true, onResolve: [], onResolveText: "El número vuelve a sonar. No era para ti." },
        ],
      },
    },
  },
    ...
    nodes: {
      open: {
        ...
        options: [
          ...
          { label: "Hablar de los votos en el Congreso", next: "gallego_pacto" },
          { label: "Marcharte sin pedir nada", onResolve: [], onResolveText: "Sale de la sala antes que tú." },
        ],
      },
      gallego_pacto: {
        text: "Feijóo hace girar la piedra una vez más y para. «¿De qué estamos hablando?». Pide más de lo que da siempre.",
        options: [
          { label: "Ofrecerle una posición de ventaja en la oposición", check: { stat: "sangre_fria", difficulty: 9 },
            outcomes: {
              critical: { text: "Asiente. Sabe que sale ganando igual. Te da cuatro votos.", effects: [{ type: E.INFLUENCE, value: 3 }, { type: E.CLUE, questId: "mocion_censura", clue: "votos_feijoo" }, { type: E.REPUTATION_POL, id: "feijoo", value: 1 }] },
              success:  { text: "«Cuatro votos, nada más». Lo firma en papel.", effects: [{ type: E.INFLUENCE, value: 2 }, { type: E.CLUE, questId: "mocion_censura", clue: "votos_feijoo" }] },
              fail:     { text: "Pone la piedra encima de la mesa. «Ni uno».", effects: [] },
              fumble:   { text: "Sale de la sala. Llama a tu rival en el pasillo.", effects: [{ type: E.REPUTATION_POL, id: "feijoo", value: -1 }, { type: E.THREAT, value: 1 }] },
            },
          },
          { label: "Marcharte sin cerrar", isExit: true, onResolve: [], onResolveText: "La piedra sigue girando sobre la mesa cuando ya no estás." },
        ],
      },
    },
  },
    ...
    nodes: {
      open: {
        ...
        options: [
          ...
          { label: "Hablar del presupuesto de la Comunidad", next: "madrid_presupuesto" },
      ...
      madrid_presupuesto: {
        text: "Ayuso aparta a Pecas y abre una carpeta. Cifras, partidas, porcentajes. «Madrid no negocia lo que ya es suyo, pero puede ceder en los márgenes». Los márgenes son donde vive la política.",
        options: [
          { label: "Proponer una línea de inversión conjunta", check: { stat: "recursos", difficulty: 9 },
            outcomes: {
              critical: { text: "Acepta la línea y añade otra. El acuerdo sale en dos páginas.", effects: [{ type: E.INFLUENCE, value: 3 }, { type: E.REPUTATION_FACTION, faction: "aparato", value: 1 }, { type: E.CLUE, questId: "mocion_censura", clue: "acuerdo_madrid" }] },
              success:  { text: "«Hay margen». Es el mejor sí que da.", effects: [{ type: E.INFLUENCE, value: 2 }, { type: E.REPUTATION_POL, id: "ayuso", value: 1 }] },
              fail:     { text: "Cierra la carpeta. «Hablamos en otoño».", effects: [] },
              fumble:   { text: "Pecas estornuda sobre los papeles. La reunión acaba.", effects: [{ type: E.REPUTATION_POL, id: "ayuso", value: -1 }, { type: E.THREAT, value: 1 }] },
            },
          },
          { label: "Pedir financiación extra para una partida específica", check: { stat: "carisma", difficulty: 10 },
            outcomes: {
              critical: { text: "Firma la partida al momento. No pregunta para qué.", effects: [{ type: E.INFLUENCE, value: 2 }, { type: E.REPUTATION_FACTION, faction: "aparato", value: 1 }] },
              success:  { text: "Lo mete en el borrador. No es seguro hasta septiembre.", effects: [{ type: E.INFLUENCE, value: 1 }] },
              fail:     { text: "«Madrid tiene sus propias prioridades».", effects: [] },
              fumble:   { text: "Te señala una contrapartida que no puedes dar.", effects: [{ type: E.THREAT, value: 1 }] },
            },
          },
          { label: "Cerrar sin acuerdo", isExit: true, onResolve: [], onResolveText: "Vuelve a acariciar al perro. La carpeta queda sobre la mesa." },
        ],
      },
    },
  },
