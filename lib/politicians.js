...
export const POLITICIANS = [
  {
    ...
    justification: `Doctor en economía por la Universidad Camilo José Cela, Pedro Sánchez ganó las primarias del PSOE en 2014, cayó en octubre de 2016 y regresó en mayo de 2017 al frente de una campaña de carretera ya convertida en mito político. En los legajos de la Logia aparece un dato recurrente: tres servilletas firmadas con tinta roja durante aquella travesía, guardadas después en una caja de metal a la que nadie le ha conocido cerradura.

La moción de censura contra Rajoy, en junio de 2018, lo sentó en la Moncloa, y desde entonces preside un gobierno de coalición que se ha reinventado tres veces sin perder el sillón. Su Manual de resistencia (2019), oficialmente firmado con asistencia editorial, fue —según los apuntes del Cronoarchivo— transcrito en limpio por amanuenses cartujos del Sacromonte. El libro codifica los siete grados de la supervivencia política española: aguantar, prometer, prometer otra cosa, esperar sentencia, indultar, amnistiar y agradecer en los Premios Princesa.

Los expedientes profundos sitúan a Sánchez, descalzo sobre baldosa fría, en una sala blanca de la residencia de la Moncloa, repitiendo durante cuarenta minutos la palabra resistir en cadencia binaria mientras dos asesores cronometran la fluctuación de su pulso. Se le atribuye además un teléfono de baquelita ya sin línea, herencia anónima depositada en cajón cerrado, que descuelga cada solsticio para escuchar el zumbido del cable cortado. La Logia anota —sin acreditarla— la versión de que en 2016, junto a una hoguera en Castilla, firmó un pacto a tres bandas con un boticario sefardí y un ánima carbonaria; el objeto exacto del acuerdo sigue siendo materia de discusión interna en signatura S/16/Ω.`,
    affinities: {
...

  {
    ...
    justification: `Feijóo encadenó cuatro mayorías absolutas en la Xunta (2009–2020) y asumió la presidencia del PP en 2022. Perfil de gestor, tono bajo, disciplina de piedra. El archivo oral de Ourense, sin embargo, insiste en un hábito menos racional: madrugadas de Cuaresma en una cueva del Courel, escuchando el gotear del agua sobre pizarra marcada con iniciales que jamás se han hecho públicas.

En 2023 se quedó a las puertas de la presidencia: ganó las elecciones pero no la investidura, episodio que la liturgia popular gallega ha bautizado como el casi. El Cronoarchivo le atribuye un escapulario heredado por línea materna —la abuela Mercedes, vidente en Os Peares— al que se imputa la facultad de protegerlo del exceso de épica y de los micrófonos abiertos, no siempre con éxito.

Los expedientes ourensanos añaden, a título no acreditado, que Feijóo viaja con tres piedras del río Sil envueltas en un pañuelo de hilo, una para cada función simbólica: hablar, callar y aguantar. La piedra de aguantar ha sido reemplazada cuatro veces desde 2010 —siempre tras crisis internas del PP—; la actual se descascarilla por una cara, signo que el archivero del Sumidero del Tedio interpreta como aviso. En la rectoral familiar guarda una caja con la palabra Núñez escrita en mayúsculas y, en su interior, el retrato fotográfico de un primo segundo desaparecido en alta mar en 1981, sobre cuya identidad solo Feijóo y su madre tienen versión completa.`,
    affinities: {
...

  {
    ...
    justification: `Abascal dejó el PP en 2014 y fundó Vox junto a Ortega Lara y otros disidentes. Llegó al Congreso en 2019 y convirtió su retórica en liturgia de choque. Las actas internas de la Logia describen una escenografía recurrente: caballo, bandera, monte y un silencio largo, cuatro elementos repetidos como rito de cohesión antes de cada campaña dura.

El archivo señala que lleva siempre encima una navaja ibérica heredada de un tío segundo carlista de Álava —afilada en luna llena y enfundada en cuero curtido con orujo del valle de Mena—. En 2023 perdió cuatro veces más votos de los que ganó tras la deriva de su antigua portavoz, pero conserva intacto el rito mensual de subir al Pico de la Atalaya, mirar al sur durante un minuto exacto y descender sin haber dicho una sola palabra.

Los expedientes vasco-carlistas refieren que, en el sótano de la sede de la calle Bambú, se custodia una vitrina cerrada con tres llaves —una para cada vicepresidencia del partido— en la que descansan tres reliquias: la pezuña disecada de un toro negro nacido el 18 de julio de 1936, una bandera rojigualda con manchas de cera y una cinta magnetofónica del padre Apeztegui pronunciando, en 1967, una bendición silenciosa en gallego. Abascal cierra toda intervención plenaria con la frase «no son gente»; la Logia sostiene que opera, voluntaria o involuntariamente, como conjuro menor de circuito cerrado.`,
    affinities: {
...

  {
    ...
    justification: `Hija de un dirigente histórico de Comisiones Obreras gallegas, abogada laboralista, militante del PCE desde la juventud y diputada por Galicia. Sustituyó a Pablo Iglesias en la vicepresidencia en marzo de 2021 mediante una operación de imagen que dejó atrás la coleta y trajo el traje sastre. Negoció la reforma laboral de 2021, fundó Sumar en 2023 y mantiene desde entonces una relación pendular con el PSOE que el archivo registra como tira y afloja, con afloja ligeramente predominante.

La Logia tiene constancia de que cada equinoccio de primavera regresa a su Ferrol natal a tomar caldo gallego en compañía de tres viejas militantes que mojan ortigas en el caldo antes de bendecirlo. Lleva, además, una pulsera de hilo rojo trenzada en una asamblea sectorial de 1998 a la que se atribuye la facultad de captar conversaciones del adversario a tres habitaciones de distancia. La pulsera se rompió en mayo de 2024 y aún no ha sido reemplazada.`,
    affinities: {
...

  {
    ...
    justification: `Politólogo formado en la Complutense, doctor por la misma universidad con tesis sobre la desobediencia civil, presentador de La Tuerka, líder de Podemos desde su fundación en 2014, eurodiputado, diputado y vicepresidente del Gobierno entre enero de 2020 y marzo de 2021. Se retiró tras la derrota de las autonómicas madrileñas para fundar una escuela política, un canal y una librería en Vallecas, donde aún oficia.

Los archivos le sitúan, en su juventud, en una ceremonia presidida por un círculo de profesores titulares que lo bautizaron con agua del Manzanares —de pureza canónica más bien escasa—; la operación dejó marca: tres lunares en la nuca que, en luna nueva, despiden un brillo apenas perceptible. Conserva la coleta amputada en una vitrina de su despacho, junto a un ejemplar dedicado del Anti-Dühring y una vela votiva con su propio rostro que, según él, compró por error en un mercadillo de Tetuán.`,
    affinities: {
...

  {
    ...
    justification: `Ayuso preside la Comunidad de Madrid desde 2019 y consolidó su mayoría en 2023. Su estilo combina confrontación, pulso mediático y lectura instintiva del conflicto. La Logia le abre expediente por una virtud poco común: desplazar el foco de cada crisis en cuestión de minutos, como si supiera dónde mirar antes de que los demás adviertan la grieta.

El archivo registra que lleva un escapulario de la Almudena envuelto en celofán de un paquete de tabaco rubio comprado en Sol en mayo de 2020, durante la operación de los hoteles medicalizados. Cada mañana ordena al perro Pecas olisquear la prensa antes de hojearla: si el animal estornuda, ese diario queda apartado. En su despacho hay una pequeña efigie de Manuel Fraga sobre la mesa, sin tarjeta de visita.

Los expedientes barriobajeros recogen, además, que Ayuso celebra cada Nochebuena un pequeño aquelarre privado en una sala de la Real Casa de Correos al que acuden cuatro invitadas fijas —una vidente del Rastro, otra del Pilar, una azafata jubilada de Iberia y una taquillera del Reina Victoria— y durante el cual se decide la parrilla mediática de enero. La Logia ha localizado fotografías muy borrosas tomadas desde un balcón frontero en las que se aprecia humo verde sobre la chimenea, pese a que el edificio no la tiene. La versión oficial atribuye el humo a fuegos artificiales fuera de calendario.`,
    affinities: {
...

  {
    ...
    justification: `Puigdemont, exalcalde de Girona y expresident de la Generalitat (2016–2017), lideró el 1-O y partió hacia Bélgica tras la DUI de octubre de 2017. Desde Waterloo sostiene un centro político de exilio que opera también como símbolo. Para unos, fuga; para otros, destierro estratégico. Para la Logia, un nodo de persistencia narrativa.

El archivo ha establecido que cada víspera de Sant Jordi recibe en su jardín la visita de tres ancianas del Empordà que le entregan una rosa envuelta en papel de calco con un número manuscrito distinto cada año. Se sospecha que el número indica los meses que faltan para su próximo intento de regreso, aunque la serie es notoriamente arrítmica. Conserva un mapa de Cataluña pintado a mano sobre pizarra de tejado en el que cada noche traza con tiza las posiciones de sus enemigos jurados y de sus enemigos amados, que a menudo son los mismos.

Los expedientes ampurdaneses añaden, sin garantía notarial, que Puigdemont mantiene una correspondencia mensual con el espíritu de Francesc Macià mediante un sistema de espejo ahumado y ouija catalanizada en grafía pre-fabriana; las sesiones se celebran a las 23:14 en punto, hora belga, y duran exactamente cuarenta y siete minutos. La Logia consigna, asimismo, que el president exiliado guarda en una caja de plata un mechón de pelo cortado a sí mismo el 27 de octubre de 2017, sobre el cual jura no afeitarse la barba hasta que el mechón vuelva a crecer. La barba, observan los archiveros, no ha menguado.`,
    affinities: {
...
El archivo le imputa un colgante de plata reciclada con un símbolo ibérico mal interpretado por su propio orfebre, que ella conserva por afecto. Cada Sant Jordi reparte rosas en el barrio de la Salut a un círculo de vecinas con las que comparte una conversación pendiente desde el 15-M. La frase exacta de esa conversación no figura en ningún archivo, pero se cree que tiene que ver con un balcón y una pancarta.`,
...

  {
    ...
    justification: `Abogado laboralista sevillano, secretario general del PSOE elegido en el congreso de Suresnes (1974) durante el exilio francés, ganó cuatro elecciones consecutivas entre 1982 y 1993, tres de ellas con mayoría absoluta. Su mandato cubre la entrada en la OTAN (referéndum de 1986), la expansión del estado del bienestar, los Juegos Olímpicos de Barcelona, la Expo de Sevilla, los GAL y la corrupción del último tramo. Cría bonsáis y caza con afición conocida.

Los archivos del Aljarafe sostienen que en Suresnes fue ungido sobre una alfombra prestada, con aceite de oliva de un olivar de la familia de Alfonso Guerra, conforme a un esquema litúrgico improvisado por dos militantes vascos que se hicieron pasar por canónigos. Conserva en la finca de Ayamonte una piel de jaguar, regalo de un antiguo presidente americano, sobre la cual afirma que se le ocurren mejores ideas que sentado en un sofá. La piel ha sido reparada en dos ocasiones, una de ellas con discreción absoluta.`,
    affinities: {
...

  {
    ...
    justification: `Inspector de Hacienda, presidente de Castilla y León en 1987, secretario general y luego presidente del PP, ganó las elecciones de 1996 por la mínima y las de 2000 por mayoría absoluta. Su segundo mandato queda definido por la entrada de España en la guerra de Irak —cumbre de las Azores, marzo de 2003— y por la gestión de los atentados del 11-M, tres días antes de las elecciones que perdió contra pronóstico en marzo de 2004. Conserva un acento castellano que cultiva con esmero.

Los archivos consignan que, antes de viajar a las Azores, consultó un péndulo de oligisto rojo extraído de las minas de Almadén, manejado por un asesor que aparece en las nóminas de FAES bajo el epígrafe de gabinete documental. El péndulo, según el acta, giró tres veces en sentido horario y se detuvo en seco, lo que el asesor interpretó como vía libre. Aznar conserva el bigote idéntico desde 1989 y rechaza por sistema cualquier sugerencia de retoque, incluso en visitas a barberías ajenas.`,
    affinities: {
...

  {
    ...
    justification: `Leonés, diputado por León desde 1986, ganó las primarias del PSOE en julio del 2000 por sorpresa y las elecciones generales de marzo de 2004 tres días después del 11-M. Su mandato cubre la retirada de las tropas de Irak, la Ley de matrimonio igualitario (2005), el primer estatuto catalán reformado y, en el segundo tramo, la crisis financiera global que sigue marcando su biografía. Su gesto identitario se convirtió en una marca pública reconocible.
...
Los archivos del barrio de Salamanca registran que llevaba una llave dorada cosida al forro interior del abrigo, recuerdo de su tía abuela, que ella tocaba con el meñique antes de declarar ante la prensa. Su despacho de Cibeles incluía un cuadro pequeño de un cazador anónimo del XIX cuya mirada cambiaba según la hora, según testimonios de tres jefes de gabinete sucesivos. Aguirre dijo que ese cuadro era buena gente y se lo llevó al jubilarse.`,
...

  {
    ...
    justification: `Militar africanista, golpista en julio de 1936, vencedor de la guerra civil en abril de 1939 y jefe del Estado durante treinta y seis años, hasta su fallecimiento en noviembre de 1975. Concentró todos los poderes —jefatura del Estado, presidencia del Gobierno, mando de los tres ejércitos, jefatura del Movimiento— y diseñó la transición monárquica que se ejecutaría tras su muerte. Vivió en El Pardo, cazó en Sierra Morena, pescó en Galicia y siguió firmando penas de muerte hasta semanas antes de morir.

Los archivos profundos sostienen, sin entrar a verificarlo, que de niño solicitó al cabildo de Alba de Tormes la mano momificada de Santa Teresa, y que en la madrugada anterior a cada decisión grave la consultaba frotando con el índice el pulgar momificado. La reliquia, trasladada a El Pardo en 1937, fue devuelta al monasterio en 1975 sin ceremonia. Conserva la Logia un guante negro suyo, hallado en un cajón del Pazo de Meirás, con tres pelos canosos del propio caudillo y un débil olor a agua de colonia Atkinson.`,
    affinities: {
...

  {
    ...
    justification: `Vasca de Gallarta, hija y mujer de mineros, militante del PCE desde su fundación, diputada por Asturias en 1936 y autora del discurso del «no pasarán», pronunciado por radio en julio del 36. Tras la derrota partió al exilio en la Unión Soviética en marzo de 1939 y allí permaneció hasta 1977. Regresó a España con la legalización del PCE y fue elegida diputada por Asturias en las primeras elecciones democráticas. Falleció en Madrid en 1989, vestida de negro hasta el final.

El archivo registra que conservó hasta su muerte una pequeña cruz de cobre en un cajón cerrado con llave, contradicción privada que jamás explicó. Se le atribuye una memoria fonográfica capaz de reproducir, palabra por palabra, conversaciones ocurridas cinco años atrás; virtud que cultivaba con un ejercicio de respiración aprendido en Moscú durante los años cincuenta. Según las grabaciones de archivo, su voz desciende medio tono cada vez que pronuncia la palabra fascismo.`,
    affinities: {
...

  {
    ...
    justification: `Marino de carrera y hombre de confianza de Franco durante tres décadas, subsecretario de la Presidencia desde 1941, vicepresidente del Gobierno desde 1967 y, finalmente, presidente del Gobierno por separación de cargos en junio de 1973. Fue asesinado por ETA el 20 de diciembre de aquel mismo año en la calle Claudio Coello de Madrid, mediante una carga subterránea que lanzó su Dodge 3700 por encima de un edificio de cinco plantas. La explosión es conocida coloquialmente como «la ascensión».

Los archivos cósmicos sostienen, sin verificación oficial, que el almirante no se detuvo en la órbita prevista por la física newtoniana y que sigue trazando, desde el solsticio de invierno de 1973, una órbita irregular en torno a Júpiter, con paso por el perihelio cada once años aproximados. Su despacho en la Castellana, hoy restaurado para uso ministerial, conserva un calendario de mesa abierto en la página del 20 de diciembre que ningún funcionario se ha atrevido nunca a pasar.`,
    affinities: {
